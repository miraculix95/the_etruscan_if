...
const SCENE_IMAGES = {
  ...
  sq_athena_pronaia: SCENE_IMAGES_DATA.sq_athena_pronaia,
  sq_charioteer_ghost: SCENE_IMAGES_DATA.sq_charioteer_ghost,
  sq_corycian_cave: SCENE_IMAGES_DATA.sq_corycian_cave,
  sq_dionysus_festival: SCENE_IMAGES_DATA.sq_dionysus_festival,
  sq_dorieus_javelin_omen: SCENE_IMAGES_DATA.sq_dorieus_javelin_omen,
  sq_farewell_priests: SCENE_IMAGES_DATA.sq_farewell_priests,
  sq_gambling: SCENE_IMAGES_DATA.sq_gambling,
  sq_javelin: SCENE_IMAGES_DATA.sq_javelin,
  sq_last_castalia: SCENE_IMAGES_DATA.sq_last_castalia,
  sq_marketplace: SCENE_IMAGES_DATA.sq_marketplace,
  sq_megara: SCENE_IMAGES_DATA.sq_megara,
  sq_mountain_tomb: SCENE_IMAGES_DATA.sq_mountain_tomb,
  sq_olive_grove: SCENE_IMAGES_DATA.sq_olive_grove,
  sq_poet_challenge: SCENE_IMAGES_DATA.sq_poet_challenge,
  sq_shepherd: SCENE_IMAGES_DATA.sq_shepherd,
  sq_sick_pilgrim: SCENE_IMAGES_DATA.sq_sick_pilgrim,
  sq_spartan_drill: SCENE_IMAGES_DATA.sq_spartan_drill,
  sq_stars: SCENE_IMAGES_DATA.sq_stars,
  sq_sybaris_dream: SCENE_IMAGES_DATA.sq_sybaris_dream,
  sq_underworld_rocks: SCENE_IMAGES_DATA.sq_underworld_rocks,
  sq_wine_merchant: SCENE_IMAGES_DATA.sq_wine_merchant,
  sq_wrestling: SCENE_IMAGES_DATA.sq_wrestling,
};
...
const SCENE_SOUNDS = {
  ...
  act1_end: SCENE_SOUNDS_DATA.wind,
  after_pythia: SCENE_SOUNDS_DATA.oracle,
  after_race: SCENE_SOUNDS_DATA.friendship,
  approach_delphi: SCENE_SOUNDS_DATA.wind,
  castalia_spring: SCENE_SOUNDS_DATA.sacred,
  choose_corinth: SCENE_SOUNDS_DATA.wind,
  choose_east: SCENE_SOUNDS_DATA.wind,
  choose_west: SCENE_SOUNDS_DATA.wind,
  coast_decision: SCENE_SOUNDS_DATA.wind,
  competing_letters: SCENE_SOUNDS_DATA.tension,
  departure_preparations: SCENE_SOUNDS_DATA.wind,
  divine_recognition: SCENE_SOUNDS_DATA.sacred,
  dorieus_oracle: SCENE_SOUNDS_DATA.friendship,
  dorieus_story: SCENE_SOUNDS_DATA.friendship,
  dove_feather_omen: SCENE_SOUNDS_DATA.sacred,
  fasting_begins: SCENE_SOUNDS_DATA.tension,
  friendship: SCENE_SOUNDS_DATA.friendship,
  pilgrims_fire: SCENE_SOUNDS_DATA.campfire,
  priests_interrogation_1: SCENE_SOUNDS_DATA.tension,
  priests_interrogation_2: SCENE_SOUNDS_DATA.tension,
  priests_question: SCENE_SOUNDS_DATA.tension,
  pythia_aftermath: SCENE_SOUNDS_DATA.sacred,
  sardis_confession: SCENE_SOUNDS_DATA.tension,
  sq_anteroom: SCENE_SOUNDS_DATA.temple,
  sq_athena_pronaia: SCENE_SOUNDS_DATA.sacred,
  sq_black_cliff: SCENE_SOUNDS_DATA.tension,
  sq_carving_names: SCENE_SOUNDS_DATA.friendship,
  sq_charioteer_ghost: SCENE_SOUNDS_DATA.mystery,
  sq_corycian_cave: SCENE_SOUNDS_DATA.mystery,
  sq_dionysus_festival: SCENE_SOUNDS_DATA.crowd,
  sq_dorieus_javelin_omen: SCENE_SOUNDS_DATA.wind,
  sq_egyptian_merchant: SCENE_SOUNDS_DATA.campfire,
  sq_ephesus_flashback: SCENE_SOUNDS_DATA.tension,
  sq_farewell_priests: SCENE_SOUNDS_DATA.wind,
  sq_former_pythia: SCENE_SOUNDS_DATA.oracle,
  sq_gambling: SCENE_SOUNDS_DATA.campfire,
  sq_gymnasium: SCENE_SOUNDS_DATA.combat,
  sq_hecate_priestess: SCENE_SOUNDS_DATA.mystery,
  sq_javelin: SCENE_SOUNDS_DATA.combat,
  sq_last_castalia: SCENE_SOUNDS_DATA.sacred,
  sq_marketplace: SCENE_SOUNDS_DATA.crowd,
  sq_megara: SCENE_SOUNDS_DATA.wind,
  sq_moonlight_delphi: SCENE_SOUNDS_DATA.mystery,
  sq_mountain_tomb: SCENE_SOUNDS_DATA.mystery,
  sq_night_vigil: SCENE_SOUNDS_DATA.sacred,
  sq_olive_grove: SCENE_SOUNDS_DATA.sacred,
  sq_phoenician_sailor: SCENE_SOUNDS_DATA.campfire,
  sq_poet_challenge: SCENE_SOUNDS_DATA.campfire,
  sq_priests_council: SCENE_SOUNDS_DATA.tension,
  sq_pythia_attendant: SCENE_SOUNDS_DATA.tension,
  sq_sacred_way_monuments: SCENE_SOUNDS_DATA.crowd,
  sq_shepherd: SCENE_SOUNDS_DATA.wind,
  sq_sick_pilgrim: SCENE_SOUNDS_DATA.friendship,
  sq_souvenir_seller: SCENE_SOUNDS_DATA.crowd,
  sq_spartan_delegation: SCENE_SOUNDS_DATA.crowd,
  sq_spartan_drill: SCENE_SOUNDS_DATA.combat,
  sq_stars: SCENE_SOUNDS_DATA.friendship,
  sq_sybaris_dream: SCENE_SOUNDS_DATA.mystery,
  sq_theater: SCENE_SOUNDS_DATA.sacred,
  sq_treasury_visit: SCENE_SOUNDS_DATA.temple,
  sq_underworld_rocks: SCENE_SOUNDS_DATA.mystery,
  sq_wine_merchant: SCENE_SOUNDS_DATA.campfire,
  sq_wrestling: SCENE_SOUNDS_DATA.combat,
  storm_vision: SCENE_SOUNDS_DATA.storm,
  temple_calm: SCENE_SOUNDS_DATA.temple,
  temple_rush: SCENE_SOUNDS_DATA.temple,
  the_bones: SCENE_SOUNDS_DATA.mystery,
  the_omphalos: SCENE_SOUNDS_DATA.sacred,
  the_road_south: SCENE_SOUNDS_DATA.wind,
  the_stadium: SCENE_SOUNDS_DATA.crowd,
  turms_confession: SCENE_SOUNDS_DATA.friendship,
  village_info: SCENE_SOUNDS_DATA.campfire,
  village_rest: SCENE_SOUNDS_DATA.campfire,
  washing_by_brook: SCENE_SOUNDS_DATA.friendship,
  winter_in_delphi: SCENE_SOUNDS_DATA.wind,
};
